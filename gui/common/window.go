...
func WindowWidthLeft(w fyne.Window) (float32) {
	return w.Canvas().Size().Width * SplitLeft
}

func WindowWidthRight(w fyne.Window) (float32) {
	return w.Canvas().Size().Width * SplitRight
}